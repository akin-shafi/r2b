...
<html class="no-js" lang="zxx">
  <!-- Mirrored from Sandsify Systems.net/template/wetland-prev/wetland/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Jun 2022 12:00:56 GMT -->
  <head>
    <meta charset="utf-8" />
    <meta http-equiv="x-ua-compatible" content="ie=edge" />
    <title>Wetland - Multi-Purpose HTML5 Template</title>
  ...
  <body>
    ...
    <header>
      <div
        id="header-sticky"
        class="header__area header__border header__padding"
      >
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-6">
              <div
                class="header__right text-end d-flex align-items-center justify-content-end"
              >
                <div class="header__right-btn d-none d-md-flex d-xl-block">
                  <a
                    href="sign-in.html"
                    class="w-btn w-btn-transparent w-btn-transparent-2"
                    >login</a
                  >
                  <a
                    href="sign-up.html"
                    class="w-btn w-btn-blue w-btn-blue-header ml-30"
                    >Get Started</a
                  >
                </div>
                <div class="sidebar__menu d-lg-none">
                  <div
                    class="sidebar-toggle-btn sidebar-toggle-btn-2"
                    id="sidebar-toggle"
                  >
      ...
      <div class="sidebar__wrapper">
        ...
        <div class="sidebar__content">
          ...
          <div class="sidebar__info mt-350">
            <a href="#" class="w-btn w-btn-blue-2 w-btn-4 d-block mb-15 mt-15"
              >login</a
            >
    ...
    <main>
      ...
      <section class="services__area pt-110 pb-45">
        <div class="container">
          <div class="row">
            <div
              class="col-xxl-6 offset-xl-3 col-xl-6 offset-xl-3 col-lg-8 offset-lg-2 col-md-10 offset-md-1"
            >
              <div
                class="section__title-wrapper section__title-wrapper-4 text-center mb-65 wow fadeInUp"
                data-wow-delay=".3s"
              >
                <h2
                  class="section__title section__title-4 section__title-4-p-2"
                >
          ...
          <div class="row">
            ...
            >
              <div class="services__item-4 white-bg mb-30">
                <div
                  class="services__thumb-4 text-center d-flex align-items-end justify-content-center"
                >
                  <img src="assets/img/services/home-4/services-1.png" alt="" />
                </div>
                <div class="services__content-4">
                  <h3 class="services__title-4">
                    <a href="services-details.html"
                      >Finish routine tasks automatically</a
                    >
                  </h3>
                  <p>
                  ...
                  <a href="services-details.html" class="link-btn"
                    >Chat Platfrom <i class="arrow_right"></i>
                  </a>
                </div>
              </div>
            </div>
            ...
            >
              <div class="services__item-4 white-bg mb-30">
                ...
                <div class="services__content-4">
                  <h3 class="services__title-4">
                    <a href="services-details.html"
                      >Start workflows from any app</a
                    >
                  </h3>
                  <p>
                    I smashing, hanky panky chap plastered show off show off
      ...
      <section class="about__area pb-45 pt-45 p-relative">
        <div class="container">
          <div class="row align-items-center">
            <div
              class="col-xxl-5 col-xl-6 col-lg-6 col-md-9 order-last order-lg-first"
            >
              <div class="about__wrapper about__wrapper-2 mb-20">
                <div
                  class="section__title-wrapper mb-25 wow fadeInUp"
                  data-wow-delay=".3s"
                >
                ...
                <a href="contact.html" class="w-btn w-btn-3 w-btn-1"
                  >Get Started</a
                >
              </div>
            </div>
            <div
              class="col-xxl-6 offset-xxl-1 col-xl-6 col-lg-6 wow fadeInRight"
              data-wow-delay=".7s"
            >
      ...
      <section class="faq__area pt-75 pb-120">
        <div class="container">
          <div class="row">
            ...
            <div
              class="col-xxl-5 offset-xxl-1 col-xl-5 offset-xl-1 col-lg-6 col-md-8"
            >
              <div class="faq__content">
                <div
                  class="section__title-wrapper section__title-wrapper-2 mb-35 wow fadeInUp"
                  data-wow-delay=".3s"
                >
      ...
      <section class="promotion__area promotion__bg pt-125 pb-125 p-relative">
        <div class="promotion__shape">
          ...
          />
          <img
            class="promotion-plus"
            src="assets/img/icon/promotion/pro-plus.png"
            alt=""
          />
          <img
            class="promotion-triangle"
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
              <div
                class="promotion__content pl-70 promotion__right wow fadeInUp"
                data-wow-delay=".5s"
              >
                <h3 class="promotion__title">
                  Looking for enterprise <br />
                  solution.
                </h3>
                <p>They’ve taken on a growing role Over the last few year.</p>
                <a href="about.html" class="w-btn w-btn-8">read more</a>
    ...
    <footer class="footer__area grey-bg-3 pt-120 p-relative fix">
      <div class="footer__shape">
        <img
          class="footer-circle-1 footer-2-circle-1"
          src="assets/img/icon/footer/home-1/circle-1.png"
          alt=""
        />
        <img
          class="footer-circle-2 footer-2-circle-2"
      ...
      <div class="footer__top pb-65">
        <div class="container">
          <div class="row">
            <div
              class="col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-6 wow fadeInUp"
              data-wow-delay=".3s"
            >
            ...
            <div
              class="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-sm-6 wow fadeInUp"
              data-wow-delay=".5s"
            >
            ...
            <div
              class="col-xxl-3 col-xl-2 col-lg-2 col-md-4 col-sm-6 wow fadeInUp"
              data-wow-delay=".7s"
            >
            ...
            <div
              class="col-xxl-2 col-xl-3 col-lg-3 col-md-4 col-sm-6 wow fadeInUp"
              data-wow-delay="1.2s"
            >
          ...
          <div class="footer__copyright">
            <div class="row">
              <div class="col-xxl-12 wow fadeInUp" data-wow-delay=".7s">
                <div
                  class="footer__copyright-wrapper footer__copyright-wrapper-2 text-center"
                >
                  <p>
                    Copyright © 2021 All Rights Reserved powered by
                    <a href="#">Sandsify Systems</a>
                  </p>
                </div>
              </div>
            </div>
  ...
  <!-- Mirrored from Sandsify Systems.net/template/wetland-prev/wetland/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Jun 2022 12:01:05 GMT -->
</html>
