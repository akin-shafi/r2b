...
$page = 'Dashboard';
$page_title = 'R2B | Dashboard';

include(SHARED_PATH . '/admin/header/index.php');
?>
				...
				<div class="dashboard-nav">
					<div class="dashboard-nav-inner">
						...
						<ul data-submenu-title="Start">
							<li class="active"><a href="<?php echo url_for('admin/dashboard/') ?>"><i class="icon-material-outline-dashboard"></i> Dashboard</a></li>
							<li class="d-none"><a href="dashboard-messages.html"><i class="icon-material-outline-question-answer"></i> Messages <span class="nav-tag">2</span></a></li>
							<li class="d-none"><a href="dashboard-bookmarks.html"><i class="icon-material-outline-star-border"></i> Bookmarks</a></li>
							<li class="d-none"><a href="dashboard-reviews.html"><i class="icon-material-outline-rate-review"></i> Reviews</a></li>
						</ul>

						<ul data-submenu-title="Organize and Manage" class="d-none">
						...
						<ul data-submenu-title="Account" class="d-none">
...
<?php include(SHARED_PATH . '/admin/footer/index.php'); ?>
</body>
